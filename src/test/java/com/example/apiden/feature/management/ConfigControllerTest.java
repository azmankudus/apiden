...
public class ConfigControllerTest {
  ...
  void testGetAllConfig() {
    logger.info("Testing GET /api/config.");
    HttpRequest<?> request = HttpRequest.GET("/api/config");
  ...
  void testGetConfigByName() {
    ...
    HttpRequest<?> request = HttpRequest.GET("/api/config/application.api.response.include-metadata");
    HttpResponse<Map<String, Object>> response = client.toBlocking().exchange(request,
        Argument.mapOf(String.class, Object.class));
  ...
  void testUpdateConfig() {
    ...
    HttpRequest<?> request = HttpRequest.PUT("/api/config/" + prop, payload);
    HttpResponse<Map<String, Object>> response = client.toBlocking().exchange(request,
        Argument.mapOf(String.class, Object.class));
  ...
  void testRestoreConfig() {
    ...
    client.toBlocking().exchange(HttpRequest.PUT("/api/config/" + prop, payload),
        Argument.mapOf(String.class, Object.class));
  }
}
